...
def sphere_with_triangular_faces(full_path_output_file, radius, center):
    ...
    save(full_path_output_file, 
             get_v(radius, center), 
             get_f(), 
             full_path_output_file.lower().endswith('.ply') or full_path_output_file.lower().endswith('.PLY'))

if __name__ == '__main__':
    sphere_with_triangular_faces('sphere_triangular.off', 1, [0, 0, 0])
    sphere_with_triangular_faces('sphere_triangular.ply', 1, [0, 0, 0])
