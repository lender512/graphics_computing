...
def translate_mesh(full_path_input_mesh, d, full_path_output_mesh):
    ...
    translated_vertices = vertices + np.array([dx, dy, dz])
    
    save(full_path_output_mesh, translated_vertices, faces, is_ply=full_path_output_mesh.endswith('.ply') or full_path_output_mesh.endswith('.PLY'))
